...
Files in `src/utils/clarigen` are automatically generated by running `yarn clarigen`. The boilerplate can be used for running tests and scripts (and eventually, when the `@clarigen/web` stabalizes, may power the web app itself.)
