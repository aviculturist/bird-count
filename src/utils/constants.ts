...
export const DEFAULT_MAINNET_BITCOIN_EXPLORER = process.env.NEXT_PUBLIC_MAINNET_BITCOIN_EXPLORER || '';
export const DEFAULT_TESTNET_BITCOIN_EXPLORER = process.env.NEXT_PUBLIC_TESTNET_BITCOIN_EXPLORER || '';
export const DEFAULT_LOCALNET_BITCOIN_EXPLORER = process.env.NEXT_PUBLIC_LOCALNET_BITCOIN_EXPLORER || '';
